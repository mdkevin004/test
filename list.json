...
class Spider(Spider):
    ...
    def liveContent(self, url):
        ...
        a = ['#EXTM3U','#EXTINF:-1 tvg-id="民视" tvg-name="民视" tvg-logo="https://logo.doube.eu.org/民视.png" group-title="",民视', 'http://127.0.0.1:9978/proxy?do=py&type=m3u8&pid=4gtv-4gtv002,1,10', '#EXTINF:-1 tvg-id="民视新闻Y" tvg-name="民视新闻Y" tvg-logo="https://logo.doube.eu.org/民视新闻台.png" group-title="",民视新闻台Y', 'https://www.youtube.com/watch?v=ylYJSBUgaMA', '#EXTINF:-1 tvg-id="民视台湾台" tvg-name="民视台湾台" tvg-logo="https://logo.doube.eu.org/民视台湾台.png" group-title="",民视台湾台', 'http://127.0.0.1:9978/proxy?do=py&type=m3u8&pid=4gtv-4gtv001,1,6',]
